...
5.  **Finalize:** Download the JSON, rename it to `client_secret.json`, and move it to the KeyFlow root folder. Notice, the download page only appears once and no more due to Google Cloud security rules.
